...
export default function WeatherWidget({ weather }) {
  // StationPanel îți pune weather ca {loading:true,...} înainte să vină ok
  if (weather?.loading) {
    return (
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 16,
        background:
          "linear-gradient(180deg, rgba(240,251,255,0.95), rgba(255,255,255,0.95))",
        padding: 12,
      }}
    >
      <div
      ...
      >
        ...
        <div style={{ textAlign: "right" }}>
          <div style={{ fontWeight: 950, fontSize: 18 }}>{cur?.temp_c ?? "—"}°C</div>
      ...
      {/* Dacă ai daily în API (eu ți l-am pus), îl afișăm; dacă nu, nu se vede nimic */}
          ...
          {weather.daily.slice(1, 4).map((d) => (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8 }}>
                ...
                <div style={{ fontSize: 18 }}>{d.icon ?? "🌡️"}</div>
              </div>
