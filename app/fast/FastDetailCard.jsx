...
export default function FastDetailCard({ interval, isOpen, onClose }) {
  ...
  return (
    <section className={`fast-detail-card${isOpen ? " is-open" : ""}`} aria-live="polite">
      <button type="button" className="fast-detail-card__close" onClick={onClose} aria-label="Închide">
        ×
      </button>
